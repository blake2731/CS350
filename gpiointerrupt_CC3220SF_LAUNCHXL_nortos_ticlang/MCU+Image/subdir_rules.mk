...
build-1348198177: ../gpiointerrupt.syscfg
	...
	"C:/ti/sysconfig_1_12_0/sysconfig_cli.bat" --script "C:/Users/blake/workspace_v12/gpiointerrupt_CC3220SF_LAUNCHXL_nortos_ticlang/gpiointerrupt.syscfg" -o "syscfg" -s "C:/ti/simplelink_cc32xx_sdk_7_10_00_13/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
...
build-1200135503: ../image.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1_12_0/sysconfig_cli.bat" --script "C:/Users/blake/workspace_v12/gpiointerrupt_CC3220SF_LAUNCHXL_nortos_ticlang/image.syscfg" -o "syscfg" -s "C:/ti/simplelink_cc32xx_sdk_7_10_00_13/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
